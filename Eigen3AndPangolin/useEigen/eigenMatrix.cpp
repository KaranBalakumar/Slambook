...
/****************************
* This program demonstrates the usage of basic Eigen types.
****************************/
...
int main(int argc, char **argv) {
  ...
  // Additionally, Eigen provides many built-in types through typedef, but the underlying type is still Eigen::Matrix
  // For example, Vector3d is essentially Eigen::Matrix<double, 3, 1>, which represents a three-dimensional vector
  Vector3d v_3d;
  // This is the same
  ...
  matrix_33 = Matrix3d::Random();      // Random Matrix number
  cout << "random matrix: \n" << matrix_33 << endl;
